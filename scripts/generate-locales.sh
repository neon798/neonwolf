...
if [ ! -f browser/locales/shipped-locales ]; then
  echo "ERROR: Run this script from the root of the Neonwolf source code"
  exit 1
fi
...
generate_locale() {
  ...
  mv browser/locales/l10n/$1/browser/branding/official browser/locales/l10n/$1/browser/branding/neonwolf
  find browser/locales/l10n/$1 -type f -exec sed -i -e 's/Mozilla Firefox/Neonwolf/g' {} \;
  find browser/locales/l10n/$1 -type f -exec sed -i -e 's/Mozilla/Neonwolf/g' {} \;
  find browser/locales/l10n/$1 -type f -exec sed -i -e 's/Firefox/Neonwolf/g' {} \;
  echo_status "Done"
  sleep 0.3
  echo_status
}
