...
$(ff_source_tarball) :
	curl -fsSL -o public_key.asc "https://keys.openpgp.org/vks/v1/by-fingerprint/14F26682D0916CDD81E37B6D61B7B526D98F0353"
	gpg --import public_key.asc
	rm -f public_key.asc
	curl -fsSL -o $(ff_source_tarball).asc "$(ff_source_url).asc"
	curl -fsSL -o $(ff_source_tarball) "$(ff_source_url)"
