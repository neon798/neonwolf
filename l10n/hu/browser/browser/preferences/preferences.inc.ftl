librewolf-header = Neonwolf Beállítások
...
librewolf-rfp-warning =
    .message = Ez a funkció le van tiltva, mert a ResistFingerprinting engedélyezve van. Emiatt a Neonwolf a webes tartalmakat világos témával fogja megjeleníteni.
permissions-eme2 =
