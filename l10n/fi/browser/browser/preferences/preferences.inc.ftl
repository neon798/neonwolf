librewolf-header = Neonwolf-asetukset
...
librewolf-rfp-warning =
    .message = Tämä ominaisuus on pois käytöstä, koska ResistFingerprinting on käytössä. Tämä tarkoittaa, että Neonwolf pakottaa verkkosisällön näyttäytymään vaalealla teemalla.
permissions-eme2 =
