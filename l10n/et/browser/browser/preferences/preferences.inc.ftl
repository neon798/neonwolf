...
librewolf-header = Neonwolfi eelistused
...
content-blocking-section-top-level-description = Neonwolf toetab ja ranges režiimis vaikimisi kasutab täiustatud jälgimisvastast kaitset. Tagades vahekaartide olekute eraldamise, rangete keeluloendite kasutamise ja muud asjalikud privaatsusfunktsionaalsused, on see veebibrauseri üks tähtsamaid seadistusi. Meie ei soovita muude režiimide kasutamist.
...
librewolf-rfp-warning =
    .message = Kuna „ResistFingerprinting“ ehk tuvastusvastased võtted on kasutusel, siis see funktsionaalsus ei toimi. See tähendab, et Neonwolf näitab sundkorras veebisisu heledas kujunduses.
permissions-eme2 =
